...
# Parsing + Configuration Script – Cartel - SV-SIGN-5-v1 - Rev. A

This **Parsing + Configuration** script is designed for the **Cartel - SV-SIGN-5-v1** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Cartel - SV-SIGN-5-v1 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Cartel - SV-SIGN-5-v1** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
