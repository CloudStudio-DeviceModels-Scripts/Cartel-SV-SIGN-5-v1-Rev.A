...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  var ep = endpoints.addEndpoint("41", "FlowSensor", endpointType.genericFlowSensor);
  ep.variableTypeId = 1148;
  ep.accessType = endpointAccessType.readWriteCommand;
  ep.operationSecurityLevel = endpointOperationSecurityLevel.medium;
  //ep.summationAutoResetThreshold = 0;     // Checked
  ep.summationAutoResetThreshold = null;   // Unchecked
